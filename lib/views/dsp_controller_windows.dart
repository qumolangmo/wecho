                    ...
                    itemBuilder: (context, index) {
                      switch (index) {
                        ...
                        case 3:
                          return MultiSliderControlCard(
                            icon: Icons.compress,
                            title: AppLocalizations.of(context)!.compressor,
                            description: AppLocalizations.of(context)!.compressorDesc,
                            enabled: _viewModel.get<bool>(ParamID.compressorEffectEnabled),
                            expanded: true,
                            onToggleExpand: () {},
                            onToggle: (value) => _viewModel.update(ParamID.compressorEffectEnabled, value),
                            sliders: [
                              SliderConfig(
                                label: AppLocalizations.of(context)!.compressorThreshold,
                                value: _viewModel.get<int>(ParamID.compressorEffectThreshold).toDouble(),
                                min: -30,
                                max: 0,
                                unit: 'dB',
                                divisions: 30,
                                onChanged: (value) => _viewModel.update(ParamID.compressorEffectThreshold, value.toInt()),
                              ),
                              SliderConfig(
                                label: AppLocalizations.of(context)!.compressorAttack,
                                value: _viewModel.get<int>(ParamID.compressorEffectAttack).toDouble(),
                                min: 1,
                                max: 200,
                                unit: 'ms',
                                divisions: 199,
                                onChanged: (value) => _viewModel.update(ParamID.compressorEffectAttack, value.toInt()),
                              ),
                              SliderConfig(
                                label: AppLocalizations.of(context)!.compressorRelease,
                                value: _viewModel.get<int>(ParamID.compressorEffectRelease).toDouble(),
                                min: 1,
                                max: 1000,
                                unit: 'ms',
                                divisions: 999,
                                onChanged: (value) => _viewModel.update(ParamID.compressorEffectRelease, value.toInt()),
                              ),
                              SliderConfig(
                                label: AppLocalizations.of(context)!.compressorRatio,
                                value: _viewModel.get<int>(ParamID.compressorEffectRatio).toDouble(),
                                min: 1,
                                max: 10,
                                unit: '',
                                divisions: 9,
                                onChanged: (value) => _viewModel.update(ParamID.compressorEffectRatio, value.toInt()),
                              ),
                              SliderConfig(
                                label: AppLocalizations.of(context)!.compressorMakeupGain,
                                value: _viewModel.get<int>(ParamID.compressorEffectMakeupGain).toDouble(),
                                min: 0,
                                max: 15,
                                unit: 'dB',
                                divisions: 15,
                                onChanged: (value) => _viewModel.update(ParamID.compressorEffectMakeupGain, value.toInt()),
                              ),
                            ],
                          );
                        case 4:
